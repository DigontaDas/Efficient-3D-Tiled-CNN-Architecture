...
# Load SegResNet checkpoint
checkpoint_path = r"c:\Thesis_RASNET\Thesis_Trainings\Thesis_Trainings\all_four_validations\mandatory_artifacts_segresnet\best_resumed.pt"
checkpoint = torch.load(checkpoint_path, map_location='cpu', weights_only=False)

print("=== SegResNet Checkpoint ===")
