================================================================================
CLINICAL CCTA STENOSIS ANNOTATION PACKAGE — CASE CT61
================================================================================
...
3. Copy-paste or run:
   exec(open(r"H:\Thesis_Trainings\Phase3_Local_Integration\local_data\CT61\load_case_in_slicer.py").read())
