# 3D Slicer Automated Loader for CT61
# ===============================================
# Run this script inside 3D Slicer Python Console (Ctrl + `)
# or launch: Slicer.exe --python-script "H:\Thesis_Trainings\Phase3_Local_Integration\local_data\CT61\load_case_in_slicer.py"

import slicer
import os

case_dir = r"H:\Thesis_Trainings\Phase3_Local_Integration\local_data\CT61"
...
vol_node.SetName("CT61_CCTA_Scan")
...
seg_node.SetName("CT61_Coronary_and_Stenosis")
...
if segmentation.GetNumberOfSegments() >= 2:
    ...
    seg2.SetName("2. Stenosis Lesion (RCA 77%)")
    seg2.SetColor(0.95, 0.15, 0.15) # Focal Alert Red

# 4. Center 2D and 3D Views on Stenosis Notch
# Notch coordinates in IJK: (220, 219, 161)
print("Centering views on stenosis lesion (RCA notch at slice 161)...")
ras_pt = [0, 0, 0]
vol_node.TransformIndexToPhysicalPoint([220, 219, 161], ras_pt)
...
print("  - Red: Stenosis Lesion (RCA, %DS = 76.9%)")
