...
|      2 | + AttentionGate3D Only                   | Yes (3-Level)     | No                 | Standard Dice+CE             | No                   | No                | 0.7565 | 0.612  |      0.785  |   0.745  |       22.5  | 4.702M       | 0.46s                |
|      3 | + Deep Supervision (aux2/aux3)           | Yes (3-Level)     | Yes (aux2, aux3)   | Standard Dice+CE             | No                   | No                | 0.764  | 0.623  |      0.821  |   0.732  |       16.8  | 4.707M       | 0.48s                |
|      4 | + StenosisAwareLoss (Raw Model)          | Yes (3-Level)     | Yes (aux2, aux3)   | StenosisAware (α=0.4, γ=2.5) | No                   | No                | 0.7715 | 0.633  |      0.858  |   0.718  |       12.4  | 4.707M       | 0.48s                |
|      5 | + 4-Pass TTA (Inference)                 | Yes (3-Level)     | Yes (aux2, aux3)   | StenosisAware (α=0.4, γ=2.5) | Yes (3 Flips + Orig) | No                | 0.779  | 0.642  |      0.869  |   0.714  |       11.1  | 4.707M       | 1.72s                |
